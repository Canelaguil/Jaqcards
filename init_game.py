...
class New_Game:
    ...
    def __init__(self):
        ...
        self.characters = {}
        self.cards = []
        # A hop is a one-time occasion, a jump has two parts
        self.jump_size = 0
        self.jump = False
        self.hop = False
        self.hop_size = 0
    ...
    def init_goals(self, file_name):
        ...
        # test
        # print(self.characters["you"].goals["spartan"].points)
    ...
    def init_cards(self, file_name):
        ...
        print("... succesfully loaded {} cards...".format(self.no_cards))
    ...
    def play_game(self):
        ...
        self.i = 0
        jump = False
        # Specified in switch condition to get back on track
        back_on_i = 0
        ...
        while self.i < self.no_cards:
            ...
            if isinstance(card, Card):
                ...
                if self.jump:
                    # if the jump_size != 0, use that jump
                    # else use jump_i jump
                    if self.jump_size == 0: 
                        self.i += 1
                    else:
                        self.i += self.jump_size
                        self.jump_size = 0
